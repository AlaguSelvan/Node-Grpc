...
proto.sum.Sum.toObject = function(includeInstance, msg) {
  var f, obj = {
    firstNo: jspb.Message.getFieldWithDefault(msg, 1, 0),
    secondNo: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.sum.Sum.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      msg.setFirstNo(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setSecondNo(value);
      break;
    default:
      reader.skipField();
      break;
...
/**
 * optional int32 first_no = 1;
 * @return {number}
 */
proto.sum.Sum.prototype.getFirstNo = function() {
 ...
 */
proto.sum.Sum.prototype.setFirstNo = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional int32 second_no = 2;
 * @return {number}
 */
proto.sum.Sum.prototype.getSecondNo = function() {
 ...
 * @return {!proto.sum.Sum} returns this
 */
proto.sum.Sum.prototype.setSecondNo = function(value) {
